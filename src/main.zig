...
const fuse_operations = extern struct {
    getattr: ?*const fn (string, *std.os.linux.Stat, *fuse_file_info) callconv(.C) c_int = null,
    readlink: ?*const fn (string, mstring, size_t) callconv(.C) c_int = null,
    mknod: ?*const fn (string, mode_t, dev_t) callconv(.C) c_int = null,
    mkdir: ?*const fn (string, mode_t) callconv(.C) c_int = null,
    unlink: ?*const fn (string) callconv(.C) c_int = null,
    rmdir: ?*const fn (string) callconv(.C) c_int = null,
    symlink: ?*const fn (string, string) callconv(.C) c_int = null,
    rename: ?*const fn (string, string, c_uint) callconv(.C) c_int = null,
    link: ?*const fn (string, string) callconv(.C) c_int = null,
    chmod: ?*const fn (string, mode_t, *fuse_file_info) callconv(.C) c_int = null,
    chown: ?*const fn (string, uid_t, gid_t, *fuse_file_info) callconv(.C) c_int = null,
    truncate: ?*const fn (string, off_t, ?*fuse_file_info) callconv(.C) c_int = null,
    open: ?*const fn (string, *fuse_file_info) callconv(.C) c_int = null,
    read: ?*const fn (string, mstring, size_t, off_t, *fuse_file_info) callconv(.C) c_int = null,
    write: ?*const fn (string, string, size_t, off_t, *fuse_file_info) callconv(.C) c_int = null,
    statfs: ?*const fn (string, *extrn.Statvfs) callconv(.C) c_int = null,
    flush: ?*const fn (string, ?*fuse_file_info) callconv(.C) c_int = null,
    release: ?*const fn (string, *fuse_file_info) callconv(.C) c_int = null,
    fsync: ?*const fn (string, c_int, *fuse_file_info) callconv(.C) c_int = null,
    setxattr: ?*const fn (string, string, string, size_t, c_int) callconv(.C) c_int = null,
    getxattr: ?*const fn (string, string, mstring, size_t) callconv(.C) c_int = null,
    ...
    create: ?*const fn (string, mode_t, *fuse_file_info) callconv(.C) c_int = null,
    lock: ?*const fn (string, ?*fuse_file_info, c_int, *linux.Flock) callconv(.C) c_int = null,
    utimens: ?*const fn (string, *const [2]timespec, ?*fuse_file_info) callconv(.C) c_int = null,
    bmap: ?*const fn (string, size_t, *u64) callconv(.C) c_int = null,
    ioctl: ?*const fn (string, c_int, *anyopaque, ?*fuse_file_info, c_uint, *anyopaque) callconv(.C) c_int = null,
    poll: ?*const fn (string, ?*fuse_file_info, *c.fuse_pollhandle, *c_uint) callconv(.C) c_int = null,
    write_buf: ?*const fn (string, *c.fuse_bufvec, off_t, ?*fuse_file_info) callconv(.C) c_int = null,
    read_buf: ?*const fn (string, [*c][*c]c.fuse_bufvec, size_t, off_t, ?*fuse_file_info) callconv(.C) c_int = null,
    flock: ?*const fn (string, ?*fuse_file_info, c_int) callconv(.C) c_int = null,
    fallocate: ?*const fn (string, c_int, off_t, off_t, ?*fuse_file_info) callconv(.C) c_int = null,
